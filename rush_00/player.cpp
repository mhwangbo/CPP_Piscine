...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/10/07 05:10:19 by mhwangbo          #+#    #+#             */
/*   Updated: 2018/10/07 07:40:48 by mhwangbo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Player::Player(int x, int y, int mX, int mY) : _health(5), _x(x), _y(y), _mX(mX), _mY(mY), _missile(NULL) {
	return ;
}
